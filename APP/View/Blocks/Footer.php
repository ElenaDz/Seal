    ...
    <footer class="py-4">
        <div class="row inner_footer">
            ...
            <div class="call_back col-md-5 offset-md-1 mb-3">
                <form>
                    <h5>Форма обратного звонка</h5>
                    <p>Чтобы заказать звонок, введите номер</p>
                    <div class="d-flex flex-column flex-sm-row w-100 gap-2">
                        <label for="newsletter1" class="visually-hidden">Phone number</label>
                        <input id="newsletter1" type="text" class="form-control" placeholder="Phone number">
